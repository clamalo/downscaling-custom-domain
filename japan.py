...
def trim_ratio(max_mins,resolution,domain):
    ...
    if domain != 'japan':
        current_month_ds = xr.load_dataset('/Users/clamalo/documents/us_chelsa_0.'+resolution+'_'+str(currentMonth)+'_area.nc')
        current_month_ds.coords['lon'] = current_month_ds.lon + 360
        current_month_ds = current_month_ds.swap_dims({'lon': 'lon'})
        other_month_ds = xr.load_dataset('/Users/clamalo/documents/us_chelsa_0.'+resolution+'_'+str(other_month)+'_area.nc')
        other_month_ds.coords['lon'] = other_month_ds.lon + 360
        other_month_ds = other_month_ds.swap_dims({'lon': 'lon'})
    else:
        current_month_ds = xr.load_dataset('/Users/clamalo/documents/jp_chelsa_0.'+resolution+'_'+str(currentMonth)+'_area.nc')
        other_month_ds = xr.load_dataset('/Users/clamalo/documents/jp_chelsa_0.'+resolution+'_'+str(other_month)+'_area.nc')
...
def ingest_gribs(i):
    ...
    open('/Users/clamalo/documents/blend_outputs/raw_gribs/'+str(frame)+'gfs.grib2', 'wb').write(r.content)
    ...
    open('/Users/clamalo/documents/blend_outputs/raw_gribs/'+str(frame)+'gem.grib2', 'wb').write(r.content)
    ...
    if int(frame) != 0:
        client.retrieve(
            ...
            levtype="sfc",
            param=parameters,
            target='/Users/clamalo/documents/blend_outputs/raw_gribs/'+str(frame)+'ecmwf.grib'
        )


def blend_models(frame,domain):
    #load raw gribs
    gfs_ds = (xr.load_dataset('/Users/clamalo/documents/blend_outputs/raw_gribs/'+frame+'gfs.grib2'))
    gfs_ds['tp'] = gfs_ds['tp']*0.039370079003585

    ecmwf_ds = (xr.load_dataset('/Users/clamalo/documents/blend_outputs/raw_gribs/'+frame+'ecmwf.grib',engine='cfgrib'))
    ...
    if int(frame) > 6:
        gem_ds = xr.load_dataset('/Users/clamalo/documents/blend_outputs/raw_gribs/'+str(frame)+'gem.grib2', engine='cfgrib')
        gem_ds['tp'] = gem_ds['paramId_0']

        previous_gem_ds = xr.load_dataset('/Users/clamalo/documents/blend_outputs/raw_gribs/'+name_frame(int(frame)-6)+'gem.grib2', engine='cfgrib')
...
def create_frame_ds(frame,domain):
    ...
    grib_path = '/Users/clamalo/documents/blend_outputs/raw_gribs/'+frame+'gfs.grib2'
    ...
    for product_type in product_types:
        ...
        for point in points:
            ...
            for x in range(1,(max_frame+1)):
                ...
                ds_path = '/Users/clamalo/documents/blend_outputs/downscaled_gribs/'+product_type+'/'+domain+'/'+frame+'downscaled.nc'
            ...
            plt.savefig('/Users/clamalo/documents/blend_outputs/images/pointforecasts/'+product_type+'/'+domain+'/'+point_name+'_plot.png',dpi=300)
    ...
    if i != 0:
        ...
        for product_type in product_types:
            ...
            for domain in domains:
                ...
                print(domain,i)
                datestr = datestr_and_cycle()[0]
                grib_path = '/Users/clamalo/documents/blend_outputs/downscaled_gribs/'+product_type+'/'+domain+'/'+frame+'downscaled.nc'
                ...
                path = str('/Users/clamalo/documents/blend_outputs/images/'+product_type+'/'+domain+'/')
...
def github_push():
    os.chdir('/Users/clamalo/documents/blend_outputs/')
...
def create_hourly_frame(i):
    ...
    if i != 0:
        for domain in domains:
            ...
            ds.to_netcdf('/Users/clamalo/documents/blend_outputs/downscaled_gribs/hourly/'+domain+'/'+frame+'downscaled.nc', 'w')
...
def create_html_file():
    ...
    f = open('/Users/clamalo/documents/blend_outputs/model/pointforecasts.html', 'w')
...
if __name__ == '__main__':
    ...
    for domain in domains:
        ...
        accum_ds.to_netcdf('/Users/clamalo/documents/blend_outputs/downscaled_gribs/accumulated/'+domain+'/'+'accum_ds.nc')
        #set next frame
        frame = name_frame(6)
    ...
    for domain in domains:
        ...
        while int(frame) <= int(max_frame):
            print(frame,domain)
            if int(frame) == 6:
                accum_ds = xr.load_dataset('/Users/clamalo/documents/blend_outputs/downscaled_gribs/accumulated/'+domain+'/'+'accum_ds.nc')
            #add to accum_ds (total accumulated precip)
            ds = xr.load_dataset('/Users/clamalo/documents/blend_outputs/downscaled_gribs/hourly/'+domain+'/'+frame+'downscaled.nc')
            accum_ds = append_frame(ds,accum_ds)
            #save accumulated ds as netcdf
            accum_ds.to_netcdf('/Users/clamalo/documents/blend_outputs/downscaled_gribs/accumulated/'+domain+'/'+frame+'downscaled.nc', 'w')
